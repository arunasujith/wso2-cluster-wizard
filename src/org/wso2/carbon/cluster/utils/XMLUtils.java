...
//        Node dataSource = createDataSourceNode(datasourceBean);
    ...
    public static void main(String[] args) {
        try {
            ...
            File fXmlFile = new File("/home/aruna/Desktop/cluster/manager_wso2esb-4.6.0/repository/conf/user-mgt.xml");
            updateUserMgtXML(fXmlFile, "jdbc/TTTTT");

//            RegistryXMLBean registryXMLBean = new RegistryXMLBean();
//            File fXmlFile = new File("/home/aruna/Desktop/cluster/manager_wso2esb-4.6.0/repository/conf/registry.xml");
//            updateRegistryXML(fXmlFile, registryXMLBean);
//            DatasourceBean bean = new DatasourceBean();
//            File fXmlFile = new File("/home/aruna/Desktop/cluster/manager_wso2esb-4.6.0/repository/conf/datasources/master-datasources.xml");
//
//            updataMasterDatasourcesXML(fXmlFile, bean);
//            CarbonXMLBean bean = new CarbonXMLBean();
//            bean.setMgtHostName("mgt.com");
//            bean.setHostName("host.com");
//            bean.setPortOffset(2);
//            File fXmlFile = new File("/home/aruna/Desktop/manager_wso2esb-4.6.0/repository/conf/carbon.xml");
//            updateCarbonXML(fXmlFile, bean);
//            Axis2XMLBean axis2XMLBean = new Axis2XMLBean();
//            axis2XMLBean.setDomain("wso2.as.domain");
//            axis2XMLBean.setLocalMemberHost("10.100.5.41");
//            axis2XMLBean.setLocalMemberPort(4000);
//            axis2XMLBean.setOtherLocalMemberHost("10.100.5.41");
//            axis2XMLBean.setOtherLocalMemberPort(4001);
//            axis2XMLBean.setMembershipScheme("wka");
//            File fXmlFile = new File("/home/aruna/Desktop/manager_wso2esb-4.6.0/repository/conf/axis2/axis2.xml");
//            updateAxis2XML(fXmlFile, axis2XMLBean);
//            DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
//            DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
...
//
//            NodeList nList = doc.getElementsByTagName("Ports");
//
//            System.out.println("----------------------------");
//
...
//
//                System.out.println("First Name : " + eElement.getElementsByTagName("Offset").item(0).getTextContent());
//                System.out.println("Last Name : " + eElement.getElementsByTagName("ThriftEntitlementReceivePort").item(0).getTextContent());
//                eElement.getElementsByTagName("ThriftEntitlementReceivePort").item(0).setTextContent("5555555");
